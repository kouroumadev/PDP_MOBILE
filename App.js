  ...
  function minusCard() {
   ...
   useEffect(()=> {
      ...
      .then(json => setProduct({
        ...
        image: json.data.images[0].images
      }));
       ...
       <View style={styles.container}>
         <ScrollView>
           <View style={{alignItems:'center', marginHorizontal:30}}>
             ...
             <Text style={styles.price}>$ {product.sku}</Text>
           ...
           <View style={styles.addToCarContainer}>
             <TouchableOpacity style={styles.shareButton} onPress={minusCard}>
               <Text style={styles.shareButtonText}>Decrease</Text>  
             </TouchableOpacity>
             <Text style={styles.count}>{card}</Text>
             <TouchableOpacity style={styles.shareButton} onPress={addCard}>
               <Text style={styles.shareButtonText}>Increase</Text>  
             </TouchableOpacity>
           </View> 
         </ScrollView>
       </View>
